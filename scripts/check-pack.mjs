/**
 * npm pack whitelist: the published tarball must contain exactly the approved
 * files — no stray build output, no sources, no local config, no HANDOFF.md,
 * and no source maps (`.map` stays in git for debugging; it is unused at
 * runtime). Run: pnpm run check:pack
 */
